$(document).ready(function () {
    ...
    var columns2=[
        ...
        { text: '退货数量', datafield: 'number', width: 100 },
    ...
    function initGrid2() {
        ...
        $("#jqxGrid2").jqxGrid({
            ...
            rendertoolbar: function (toolbar) {
                ...
                var container = $("<div style='margin: 5px;'></div>");
                toolbar.append(container);
                container.append('<input id="addrowbutton" type="button" value="确认退货" />');
    ...
    function returnGood() {
        ...
        for(var i=0;i<rows.length;i++){
            ...
            row['returnPrice'] = rows[i].buyingPrice;
            row['returnNumber'] = rows[i].number;
